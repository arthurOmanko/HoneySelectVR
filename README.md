...
`<CameraFrontLightRotationToDefaultOnSceneLoad>` | 0 | On loading scene, whether making the rotation of default directional front lights set at default rotation or not (using saved lights rotation data). [0 = using saved data, 1 = set at default rotation]
