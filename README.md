...
- On VR environment, light shadow settings would be severe, so set default preferrable values of light shadows on ${GameFolder}\UserData\GraphicSetting\Shadow\arthur_Shadow.com.
