...
- ***<ins>${GameFolder}/Plugins/ShortcutPlugin.dll or ShortcutHSparty.dll sometimes causes some problem. So you might should remove it if any problem keeping.</ins>***
